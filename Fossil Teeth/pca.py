...
plt.plot(-2,0)
plt.plot([-2,unit_vecs[0,1]],[0,unit_vecs[0,0]],label='LENGTH',linewidth=4)
plt.legend()
plt.tight_layout()
plt.savefig('PCA_length.png')

plt.plot([-2,unit_vecs[1,1]],[0,unit_vecs[1,0]],label='WIDTH',linewidth=4,linestyle='dashed',c='black')
plt.legend()
plt.tight_layout()
plt.savefig('PCA_length_width.png')

plt.plot([-2,unit_vecs[2,1]],[0,unit_vecs[2,0]],label='TRILENGTH',linewidth=4,linestyle='dashdot',c='tab:red')
plt.legend()
plt.tight_layout()
